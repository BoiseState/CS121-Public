...
/**
 * The PhotoAlbumManager uses (depends on) the PhotoAlbum class. Note that this
 * could also be an aggregate class that has a PhotoAlbum.
 * 
 * How could we make this easier to read/maintain through better method design?
 * 
...
public class PhotoAlbumManager {
	...
	public static void main(String[] args) {
		...
		PhotoAlbum album = showInitialMenu(scan);

		System.out.println("Photo album added.");
		System.out.println(album);

		showUserMenu(scan, album);
	}

	private static void showUserMenu(Scanner scan, PhotoAlbum album) {
	...
	private static PhotoAlbum showInitialMenu(Scanner scan) {
		// TODO Auto-generated method stub
	...
	/**
	 * Reads photo information from the user (via the scanner) and creates a new
	 * Photo object.
	 *
